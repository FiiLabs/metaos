...
import (
	...
	evmclient "github.com/FiiLabs/metaos/modules/evm/client"
	evmserver "github.com/FiiLabs/metaos/modules/evm/server"
)
...
func (ac appCreator) appExport(
	...
	if height != -1 {
		if err := metaosApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	}

	return metaosApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
