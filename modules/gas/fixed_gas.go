...
var (
	...
	DefaultGasConfig = map[string]uint64{
		sdk.MsgTypeURL(&nfttypes.MsgIssueDenom{}): 20000,
		sdk.MsgTypeURL(&nfttypes.MsgMintNFT{}):    20000,
		sdk.MsgTypeURL(&mttypes.MsgIssueDenom{}):  20000,
		sdk.MsgTypeURL(&mttypes.MsgMintMT{}):      20000,
	}
	DefaultGas         = uint64(20000)
	DefaultSimulateGas = uint64(20000)
)
