...
func TestMsgMintGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"metaos/opb/MsgMint","value":{"amount":"1000","operator":"cosmos1hjppmlx4fgtnpsya0pzqyg7el9qrq5lw58dd9x","recipient":"cosmos1hjppmlx4fgtnpsya0pzqyg7el9qrq5lw58dd9x"}}`
...
func TestMsgReclaimGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"metaos/opb/MsgReclaim","value":{"denom":"stake","operator":"cosmos1hjppmlx4fgtnpsya0pzqyg7el9qrq5lw58dd9x","recipient":"cosmos1hjppmlx4fgtnpsya0pzqyg7el9qrq5lw58dd9x"}}`
	require.Equal(t, expected, string(res))
}
